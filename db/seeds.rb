...
Disease.create!(user_id: "2", name: 'Cavirus', image: 'coronavirus.jpg', description: 'any of a group of RNA viruses that cause a variety of diseases in humans and other animals.')
Disease.create!(user_id: "2", name: 'Biflu', image: 'bird_flu.jpg', description: 'Bird flu, also called avian influenza, is a viral infection that can infect not only birds, but also humans and other animals. Most forms of the virus are restricted to birds.')
Disease.create!(user_id: "2", name: 'Dbelly', image: 'delhi_belly.jpg', description: 'an upset stomach accompanied by diarrhoea, especially as suffered by visitors to India.')
Disease.create!(user_id: "2", name: 'Gastiritis', image: 'gastro.jpg', description: 'The majority of cases of acute diarrhea correspond to gastroenteritis of viral origin, most often trivial and of short duration.')
Disease.create!(user_id: "2", name: 'Meas', image: 'measles.jpg', description: 'Measles is a highly contagious infectious disease caused by the measles virus.Symptoms usually develop 10–12 days after exposure to an infected person and last 7–10 days.')
Disease.create!(user_id: "2", name: 'Foooisoning', image: 'food_poisoning.jpg', description: 'illness caused by bacteria or other toxins in food, typically with vomiting and diarrhoea.')
Disease.create!(user_id: "2", name: 'Chldia', image: 'chlamydia.jpg',description: 'is a sexually transmitted infection caused by the bacterium Chlamydia trachomatis.')
